...
import "./styles.css";
import img from "../Navbar/Vector (1).svg"
       ...
       <div>
            <Container>
                ...
                <p className="ds"><img src={img} /> Digital Store</p>
                    <TextField label="O que você procura..." sx={{width: "500px"}}/>
                    <Stack direction="row" spacing={3} sx={{alignItems: "center"}}>
                        <Button className="cad" variant="text" sx= {{color:grey[600]}}>Cadastre-se</Button>
